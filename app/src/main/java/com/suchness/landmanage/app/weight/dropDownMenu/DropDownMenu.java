package com.suchness.landmanage.app.weight.dropDownMenu;
...
import com.suchness.landmanage.app.utils.DeviceUtils;
...
public class DropDownMenu extends LinearLayout {
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        tabMenuView = new RelativeLayout(context);
    ...
    public void setDropDownMenu(@NonNull List<String> tabTexts, @NonNull List<View> popupViews, @NonNull View contentView) {
        ...
        maskView.setLayoutParams(new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, 50));
    ...
    public void setTitle(@NonNull String t){
        if (tabMenuView.getChildCount()==2){
            ((TextView)tabMenuView.getChildAt(1)).setText(t);
        }else{
            ...
            title.setText(t);
            title.setPadding(dpTpPx(5), dpTpPx(12), dpTpPx(5), dpTpPx(12));
            tabMenuView.addView(title);
        }
    }
    ...
    private void switchMenu(View target) {
        if (target == tabMenuView.getChildAt(0)){
            if (current_tab_position == 0){
                closeMenu();
            }else{
                if (current_tab_position == -1) {
                ...
                ((TextView) tabMenuView.getChildAt(0)).setTextColor(textSelectedColor);

                ((TextView) tabMenuView.getChildAt(0)).setCompoundDrawablesWithIntrinsicBounds(null, null,
...
//        }
    ...
    public View getTabMenuView(){
        return tabMenuView;
    }

    public void closePopuMenu(){
        closeMenu();
    }
}
