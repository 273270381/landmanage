 ...
 */
package com.suchness.landmanage.app.weight.playback;
...
public class QueryPlayBackLocalListAsyncTask extends HikAsyncTask<String, Void, Integer> {
    ...
    public QueryPlayBackLocalListAsyncTask(String deviceSerial, int channelNo,
                                           QueryPlayBackListTaskCallback playBackListTaskCallback, Context context) {
        MINUTE = context.getString(R.string.local_play_hour);
