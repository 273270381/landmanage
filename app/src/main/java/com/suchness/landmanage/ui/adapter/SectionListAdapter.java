...
import com.suchness.landmanage.app.utils.DataManager;
...
import com.suchness.landmanage.app.weight.playback.MySectionIndexer;
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (fileEx.isMore()) {
            ...
            if (isEdit) {
                ...
                holder.moreBtn.setTextColor(inflater.getContext().getResources().getColor(R.color.Grey300));
