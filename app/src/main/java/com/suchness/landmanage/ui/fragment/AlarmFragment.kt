 ...
 */
class AlarmFragment : BaseFragment<AlarmViewModel, FragmentViewPagerBinding>() {
    private lateinit var loadsir: LoadService<Any>
    var fragments: ArrayList<Fragment> = arrayListOf()
    var mDataList: ArrayList<String> = arrayListOf("交通管控","治安管控","城市管理")
    ...
    private fun addFragment() {
        ...
        mDataList.let {
            it.forEachIndexed { index, s ->
                fragments.add(AlarmChildFragment.newInstance(s))
            }
